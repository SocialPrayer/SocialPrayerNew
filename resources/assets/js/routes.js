...
export default [
  ...
  ...authGuard([
    { path: '/home', name: 'home', component: require('./pages/prayers/prayers.vue') },
    { path: '/prayers', name: 'prayers', component: require('./pages/prayers/prayers.vue'), children: [
        { path: '/prayer', name: 'prayer', component: require('./pages/prayers/prayer.vue') }
    ] },
